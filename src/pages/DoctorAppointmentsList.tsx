          ...
          <tr className="border-b border-gray-300 text-gray-700">
            ...
            <td>
              {appointment.status === 'completed' && (
                <span className="text-green-500 uppercase font-semibold border border-green-500 py-1 px-3 rounded-lg text-sm">
                  paid
                </span>
              )}
              {appointment.status === 'pending' &&
                (appointment.paid ? (
                  ...
                  <span className="text-red-500 uppercase font-semibold border red-green-500 py-1 px-3 rounded-lg text-sm">
                    unpaid
                  </span>
                ))}
              {appointment.status === 'cancelled' && (
                <hr className="w-2 ml-4" />
              )}
            </td>
